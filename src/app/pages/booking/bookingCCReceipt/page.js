...
export default function BookingCCReceipt() {
  ...
  const [trecdsum, setTrecdsum] = useState(0);
  ...
  useEffect(()=> {
    if(resDetails && resDetails.reportDetails){
      ...
      resDetails.ccDetails?.map((c, i) => {
        trecdsumV = trecdsumV + parseFloat(c.netAmt)/ parseFloat(resDetails.reportDetails[i].custExchangeRate);
      });
      setTrecdsum(trecdsumV);
                    ...
                    <tbody>
                      <tr>
                        <td>
                            <table width="100%" cellPadding="10" cellSpacing="0" style={{borderBottom:'3px solid #e1e1e1',fontFamily:'Arial, Helvetica, sans-serif',fontSize:'13px'}}>
                              <tbody>
                                <tr>
                                  ...
                                  <td width="33%" align="center"><strong style={{fontSize:'18px'}}>PAYMENT RECEIPT</strong></td>
                                                ...
                                                <>
                                                  ...
                                                  <tr>
                                                    <td colSpan="11" align="right">
                                                      ...
                                                      <strong><>{v.custCurrency} {parseFloat(v.actCancellationCharges).toFixed(2)}</></strong>
                                                    </td>
                                                  </tr> : null
                                                  }
                                                </> : null
                            ...
                            {resDetails.ccDetails?.map((c, i) => (
                              <table key={i} width="100%" cellPadding="10" cellSpacing="0">
                                <tbody>
                                  <tr>
                                    <td bgcolor="#eef5f6" style={{backgroundColor:'#eef5f6 !important'}} valign="middle">
                                      ...
                                      <table className='table-bordered' width="100%" cellPadding="5" cellSpacing="0" bordercolor="#dfdede" border="1" style={{borderCollapse:'collapse',borderSpacing:'0px',fontFamily:'Arial, Helvetica, sans-serif',fontSize:'13px',lineHeight:'21px'}}>
                                        <thead>
                                          <tr bgcolor="#f9f9f9" style={{backgroundColor:'#f9f9f9 !important'}}>
                                            <th style={{textAlign:'left'}} colSpan="2">CARD PAYMENT DETAIL</th>
                                          </tr>
                                        </thead>
                                        <tbody>
                                          <tr bgcolor="#ffffff" style={{backgroundColor:'#ffffff !important'}}>
                                          ...
                                          <tr bgcolor="#ffffff" style={{backgroundColor:'#ffffff !important'}}>
                                            ...
                                            <td>{c.authenticationStatus?.toLowerCase() ==="true" ? <>Success</>:<>Failure</>}</td>
                                          </tr>         
                                          <tr bgcolor="#ffffff" style={{backgroundColor:'#ffffff !important'}}>
                                            <td><strong>Gross Amount:</strong></td>
                                            <td>{c.currencyCode} {parseFloat(c.grossAmt).toFixed(2)} ({resDetails.reportDetails[i].custCurrency} {parseFloat(parseFloat(c.grossAmt)/resDetails.reportDetails[i].custExchangeRate).toFixed(2)})</td>
                                          </tr>
                                          <tr bgcolor="#ffffff" style={{backgroundColor:'#ffffff !important'}}>
                                            <td><strong>Service Charge:</strong></td>
                                            <td>{c.currencyCode} {parseFloat(c.serviceCharge).toFixed(2)} ({resDetails.reportDetails[i].custCurrency} {parseFloat(parseFloat(c.serviceCharge)/resDetails.reportDetails[i].custExchangeRate).toFixed(2)})</td>
                                          </tr>
                                          <tr bgcolor="#ffffff" style={{backgroundColor:'#ffffff !important'}}>
                                            <td><strong>Net Amount:</strong></td>
                                            <td>{c.currencyCode} {parseFloat(c.netAmt).toFixed(2)} ({resDetails.reportDetails[i].custCurrency} {parseFloat(parseFloat(c.netAmt)/resDetails.reportDetails[i].custExchangeRate).toFixed(2)})</td>
                                          </tr>
                                        </tbody>
                                      </table> 
                              ...
                              <tbody>
                                <tr>
                                  <td width="65%" bgcolor="#eef5f6" style={{backgroundColor:'#eef5f6 !important'}} valign="middle">
                                    <div style={{textTransform:'capitalize'}}>TOTAL RECD:&nbsp; 
                                      <>
                                      <strong>
                                        {process.env.NEXT_PUBLIC_SYSROUNDING==='0' ?
                                          <>{CurrencyWords.currencyToWords(parseFloat(trecdsum).toFixed(2), custCurrency)}</>
                                          :
                                          <>{CurrencyWords.currencyToWords(parseFloat(Math.ceil(parseFloat(trecdsum))).toFixed(2), custCurrency)}</>
                                        }
                                      </strong>
                                      </>
                                    </div>
                                    ...
                                    <div style={{fontSize:'21px',textAlign:'right',lineHeight:'36px',color:'#FFF !important',color:'#FFF'}}>
                                      <>{custCurrency}&nbsp; 
                                        <span className='totalAmountCnvrt'>
                                          {process.env.NEXT_PUBLIC_SYSROUNDING==='0' ?
                                            <>{parseFloat(trecdsum).toFixed(2)}</>
                                            :
                                            <>{parseFloat(Math.ceil(parseFloat(trecdsum))).toFixed(2)}</>
                                          }
                                        </span>
                                      </>
                                    </div>               
                                      ...
                                      <tbody>
                                          <tr>
                                            <td valign="top" style={{lineHeight:'21px'}}>
                                              {process.env.NEXT_PUBLIC_SHORTCODE !=="ZAM" ?
                                              <>
                                              <strong>Confirmation Remarks :</strong> Please note that we are not responsible for the remittance fee or any other financial charges deducted by either your bank or your bank correspondents. It has been noted that some bank correspondents charge (deduct) an amount of $ 25 or $ 45 for delivering the transferred funds.
                                              </>:null
                                              }
