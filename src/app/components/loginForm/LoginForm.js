  ...
  return (
    ...
    <div>
      ...
      <div className="mb-2 text-end">
        <span className="curpointer" onClick={()=> (setResetEmailForm(true), setLoginForm(false) )}>Forgot password?</span>
      </div>
      <div className="mb-1">
    ...
    <div>
      ...
      <p className="fs-5 mb-3">OTP has been generated and sent to your email id {userDtl?.user?.userEmail}</p>
      <div>
